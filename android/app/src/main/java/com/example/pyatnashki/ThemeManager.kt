...
object ThemeManager {
    ...
    val themes: List<GameTheme> = listOf(
        ...
        GameTheme(
            id = "neon3d",
            name = "Неон 3D",
            bgColor               = Color.parseColor("#FF0D0015"),
            boardBgColor          = Color.parseColor("#FF15002A"),
            boardBorderColor      = Color.parseColor("#FFFF0080"),
            tileBgColor           = Color.parseColor("#FF2A0050"),
            tileBorderColor       = Color.parseColor("#FFCC0099"),
            tileTextColor         = Color.parseColor("#FFFF66FF"),
            correctTileBorderColor = Color.parseColor("#FFFFDD00"),
            correctTileTextColor  = Color.parseColor("#FFFFDD00"),
            titleColor            = Color.parseColor("#FFFF00CC"),
            statsColor            = Color.parseColor("#FFFF66FF"),
            mutedColor            = Color.parseColor("#88FF00CC"),
            btnStrokeColor        = Color.parseColor("#FFFF00CC"),
            titleText             = "ПЯТНАШКИ",
            subtitleText          = "▼ NEON 3D ▼ CONTROL PANEL ▼",
            tileCornerDp          = 4,
            typeface              = 0,
            is3D                  = true,
        ),
        ...
        GameTheme(
            id = "lava3d",
            name = "Лава 3D",
            bgColor               = Color.parseColor("#FF120500"),
            boardBgColor          = Color.parseColor("#FF1E0800"),
            boardBorderColor      = Color.parseColor("#FFCC3300"),
            tileBgColor           = Color.parseColor("#FF2D0A00"),
            tileBorderColor       = Color.parseColor("#FFFF4400"),
            tileTextColor         = Color.parseColor("#FFFF8C00"),
            correctTileBorderColor = Color.parseColor("#FFFFD700"),
            correctTileTextColor  = Color.parseColor("#FFFFD700"),
            titleColor            = Color.parseColor("#FFFF4400"),
            statsColor            = Color.parseColor("#FFFF6600"),
            mutedColor            = Color.parseColor("#88FF4400"),
            btnStrokeColor        = Color.parseColor("#FFFF4400"),
            titleText             = "ПЯТНАШКИ",
            subtitleText          = "* ЛАВА 3D * MAGMA EDITION *",
            tileCornerDp          = 3,
            typeface              = 0,
            is3D                  = true,
        ),
        ...
        GameTheme(
            id = "kawaii",
            name = "Кошечки 🐱",
            bgColor               = Color.parseColor("#FFFFF0F8"),
            boardBgColor          = Color.parseColor("#FFFFDFEE"),
            boardBorderColor      = Color.parseColor("#FFFF69B4"),
            tileBgColor           = Color.parseColor("#FFFFC8E0"),
            tileBorderColor       = Color.parseColor("#FFFF85C2"),
            tileTextColor         = Color.parseColor("#FFCC1177"),
            correctTileBorderColor = Color.parseColor("#FF9B59B6"),
            correctTileTextColor  = Color.parseColor("#FF9B59B6"),
            titleColor            = Color.parseColor("#FFCC1177"),
            statsColor            = Color.parseColor("#FFCC1177"),
            mutedColor            = Color.parseColor("#88CC1177"),
            btnStrokeColor        = Color.parseColor("#FFFF69B4"),
            titleText             = "🐱 Кошечки 🐱",
            subtitleText          = "~ милые кошечки ~",
            tileCornerDp          = 18,
            typeface              = 2,
            tileEmoji             = "🐾",
        ),
